...
struct ShaderBuild
{
	...
	//used to inject #define values
	//NOTE: currently the main .define() injection replaces #define macros and does not add them. except in the case of defining VERTEX, FRAGMENT etc
